...
always_comb begin
	...
	// SR = 77
		7'd77:	mcode =	{	NEXTPC_FETCH,		COND_MASK_NUL,		COND_XOR_NUL,		BUS_NUL,	LD_L_ACC,		LD_H_NUL,	RD_L_ACC,	RD_H_P0,	WR_L_ALU,	WR_H_RD_H,	ALU_OP_RRL,	ALU_CY_IN_ZERO,		CTL_NUL		};
	// SRL = 78
		7'd78:	mcode =	{	NEXTPC_FETCH,		COND_MASK_NUL,		COND_XOR_NUL,		BUS_NUL,	LD_L_ACC,		LD_H_NUL,	RD_L_ACC,	RD_H_P0,	WR_L_ALU,	WR_H_RD_H,	ALU_OP_RRL,	ALU_CY_IN_STATUS,	CTL_NUL		};
	// RR = 79
		7'd79:	mcode =	{	NEXTPC_FETCH,		COND_MASK_NUL,		COND_XOR_NUL,		BUS_NUL,	LD_L_ACC,		LD_H_NUL,	RD_L_ACC,	RD_H_P0,	WR_L_ALU,	WR_H_RD_H,	ALU_OP_RRL,	ALU_CY_IN_RD0,		CTL_NUL		};
	// RRL = 80
		7'd80:	mcode =	{	NEXTPC_FETCH,		COND_MASK_NUL,		COND_XOR_NUL,		BUS_NUL,	LD_L_ACC_STAT_CY,	LD_H_NUL,	RD_L_ACC,	RD_H_P0,	WR_L_ALU,	WR_H_RD_H,	ALU_OP_RRL,	ALU_CY_IN_STATUS,	CTL_NUL		};
