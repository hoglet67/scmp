...
// COND_MASK
typedef logic [8:0] COND_MASK_t;

const	COND_MASK_t	COND_MASK_NUL	= 9'd0;
const	COND_MASK_t	COND_MASK_OP2	= 9'b100000000;
const	COND_MASK_t	COND_MASK_ADI	= 9'b011100000;
const	COND_MASK_t	COND_MASK_JMP	= 9'b000010000;
const	COND_MASK_t	COND_MASK_POSTINC	= 9'b000001000;
const	COND_MASK_t	COND_MASK_RDL80	= 9'b000000100;
const	COND_MASK_t	COND_MASK_NOTCARRY	= 9'b000000010;
const	COND_MASK_t	COND_MASK_NOTHALFCARRY	= 9'b000000001;
// COND_XOR
typedef logic [8:0] COND_XOR_t;

const	COND_XOR_t	COND_XOR_NUL	= 9'd0;
const	COND_XOR_t	COND_XOR_OP2	= 9'b000000000;
const	COND_XOR_t	COND_XOR_ADI	= 9'b010000000;
const	COND_XOR_t	COND_XOR_JMP	= 9'b000000000;
const	COND_XOR_t	COND_XOR_POSTINC	= 9'b000001000;
const	COND_XOR_t	COND_XOR_POSTINCNEG	= 9'b000000000;
const	COND_XOR_t	COND_XOR_RDL80	= 9'b000000100;
const	COND_XOR_t	COND_XOR_NOTCARRY	= 9'b000000010;
const	COND_XOR_t	COND_XOR_NOTHALFCARRY	= 9'b000000001;
// BUS
typedef enum {
	BUS_IX_WR	= 'd0,
	BUS_IX_RD	= 'd1,
...
const	LD_L_t	LD_L_STAT	= 15'b000000010000000;
const	LD_L_t	LD_L_D	= 15'b000000100000000;
const	LD_L_t	LD_L_D80	= 15'b000001000000000;
const	LD_L_t	LD_L_OP	= 15'b000010000000000;
const	LD_L_t	LD_L_ST_CY	= 15'b000100000000000;
const	LD_L_t	LD_L_ST_OV	= 15'b001000000000000;
const	LD_L_t	LD_L_EA	= 15'b010000000000000;
const	LD_L_t	LD_L_EAM	= 15'b100000000000000;
...
const MCODE_IX_t UCLBL__CL = 7'd57;
const MCODE_IX_t UCLBL_XPAH = 7'd54;
const MCODE_IX_t UCLBL_LDE = 7'd13;
const MCODE_IX_t UCLBL_XPAL = 7'd51;
const MCODE_IX_t UCLBL_DLD = 7'd34;
const MCODE_IX_t UCLBL_EAPOSTINC1 = 7'd28;
const MCODE_IX_t UCLBL_DECODE = 7'd7;
const MCODE_IX_t UCLBL_XAE = 7'd48;
const MCODE_IX_t UCLBL_FETCH = 7'd0;
const MCODE_IX_t UCLBL_EAR2 = 7'd25;
const MCODE_IX_t UCLBL_ILD = 7'd40;
...
const MCODE_IX_t UCLBL_ST = 7'd30;
const MCODE_IX_t UCLBL_EAOFFSEXT = 7'd27;
const MCODE_IX_t UCLBL_JMP = 7'd46;
