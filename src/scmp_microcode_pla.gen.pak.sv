...
const	COND_MASK_t	COND_MASK_NOTALUCARRY	= 10'b0000000001;
// COND_XOR
...
const	COND_XOR_t	COND_XOR_NOTALUCARRY	= 10'b0000000001;
// BUS
typedef enum {
	BUS_IX_WR	= 'd0,
	BUS_IX_RD	= 'd1,
...
const MCODE_IX_t UCLBL_ADD = 7'd14;
const MCODE_IX_t UCLBL_ADE = 7'd20;
const MCODE_IX_t UCLBL_ADI = 7'd18;
const MCODE_IX_t UCLBL_CAD = 7'd21;
const MCODE_IX_t UCLBL_CAE = 7'd28;
const MCODE_IX_t UCLBL_CAI = 7'd25;
const MCODE_IX_t UCLBL_CAS = 7'd96;
const MCODE_IX_t UCLBL_CSA = 7'd95;
const MCODE_IX_t UCLBL_DAD = 7'd29;
const MCODE_IX_t UCLBL_DAE = 7'd39;
const MCODE_IX_t UCLBL_DAI = 7'd33;
const MCODE_IX_t UCLBL_DECODE = 7'd7;
const MCODE_IX_t UCLBL_DLD = 7'd52;
const MCODE_IX_t UCLBL_DLY = 7'd87;
const MCODE_IX_t UCLBL_EA = 7'd40;
const MCODE_IX_t UCLBL_EAPOSTINC1 = 7'd45;
const MCODE_IX_t UCLBL_EAR2 = 7'd43;
...
const MCODE_IX_t UCLBL_NOP = 7'd98;
const MCODE_IX_t UCLBL_RESET = 7'd0;
const MCODE_IX_t UCLBL_RR = 7'd105;
const MCODE_IX_t UCLBL_RRL = 7'd106;
const MCODE_IX_t UCLBL_SIO = 7'd102;
const MCODE_IX_t UCLBL_SR = 7'd103;
const MCODE_IX_t UCLBL_SRL = 7'd104;
const MCODE_IX_t UCLBL_ST = 7'd47;
const MCODE_IX_t UCLBL_XAE = 7'd73;
const MCODE_IX_t UCLBL_XPAH = 7'd80;
const MCODE_IX_t UCLBL_XPAL = 7'd76;
const MCODE_IX_t UCLBL_XPPC = 7'd84;
const MCODE_IX_t UCLBL__CL = 7'd92;
const MCODE_IX_t UCLBL__IE = 7'd93;
