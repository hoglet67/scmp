...
const MCODE_IX_t UCLBL_NOP = 7'd99;
const MCODE_IX_t UCLBL_SIO = 7'd103;
const MCODE_IX_t UCLBL_ADE = 7'd20;
const MCODE_IX_t UCLBL_LDI = 7'd12;
const MCODE_IX_t UCLBL_DAE = 7'd39;
const MCODE_IX_t UCLBL_RRL = 7'd107;
const MCODE_IX_t UCLBL_DAD = 7'd29;
const MCODE_IX_t UCLBL_RR = 7'd106;
...
const MCODE_IX_t UCLBL_SRL = 7'd105;
const MCODE_IX_t UCLBL__CL = 7'd93;
const MCODE_IX_t UCLBL_SR = 7'd104;
const MCODE_IX_t UCLBL_CAS = 7'd97;
...
const MCODE_IX_t UCLBL__IE = 7'd94;
const MCODE_IX_t UCLBL_CSA = 7'd96;
...
const MCODE_IX_t UCLBL_HALT = 7'd100;
